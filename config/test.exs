...
config :account_manager, AccountManagerWeb.Endpoint,
  ...
  secret_key_base: "rMO5k+Ul9cMxTJ5ZrSSIouuT6PyCJCQPfKgryOjy9ywnNChT7Tqk0WsBkOAn1RK7",
  server: false

# In test we don't send emails.
config :account_manager, AccountManager.Mailer, adapter: Swoosh.Adapters.Test
